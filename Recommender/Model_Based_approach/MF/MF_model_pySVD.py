...
def formatData(corpus,lexicon,playlists_LUT,artists_LUT):
	...
	for playListId in corpus:
		...
		for artistId,counts in acc.items():
			outCorpus.append((artists_LUT[artistId],playlists_LUT[playListId],float(counts)/len(acc)))
...
if __name__ == "__main__":
	...
	CORPUS = removeSmallPlaylists(CORPUS,LEXICON,threshold_artistCount=3,threshold_artistPop=200)
